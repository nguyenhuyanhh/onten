...
/**
 * Created by zhenting on 13/3/2016.
 */
public class QuizActivity1 extends AppCompatActivity {
        ...
        buttonExit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (clicked == true || clicked == false) {
                    ...
                    Intent intent = new Intent(QuizActivity1.this, MainActivity.class);
                    Bundle b = new Bundle();
                    startActivity(intent);
                    finish();
    ...
    private void initInstances() {
        ...
        drawerToggle = new ActionBarDrawerToggle(QuizActivity1.this, drawerLayout, R.string.hello_world, R.string.hello_world);
...
//                }
                ...
                switch (id) {
                    ...
                    case R.id.navigation_item_2:
                        startActivity(new Intent(QuizActivity1.this, ContributorsActivity.class));
                        break;
                    case R.id.navigation_item_3:
                        startActivity(new Intent(QuizActivity1.this, EditorialBoardActivity.class));
                        break;
                    case R.id.navigation_item_4:
                        startActivity(new Intent(QuizActivity1.this, DisclaimersActivity.class));
                        break;
                    case R.id.navigation_item_5:
                        startActivity(new Intent(QuizActivity1.this, LoginActivity.class));
                        break;
                    case R.id.navigation_item_6:
                        startActivity(new Intent(QuizActivity1.this, RegistrationActivity.class));
                        break;
                    case R.id.navigation_item_10:
                        startActivity(new Intent(QuizActivity1.this, QuizActivity.class));
                        break;
                    case R.id.navigation_item_11:
                        startActivity(new Intent(QuizActivity1.this, QuizActivity1.class));
                        break;
                    case R.id.navigation_item_100:
                        startActivity(new Intent(QuizActivity1.this, ComplexNumbersActivity.class));
                        break;
                    case R.id.navigation_item_101:
                        startActivity(new Intent(QuizActivity1.this, ComplexVariablesActivity.class));
                        break;
                    case R.id.navigation_item_102:
                        startActivity(new Intent(QuizActivity1.this, DeterminantsActivity.class));
                        break;
                    case R.id.navigation_item_103:
                        startActivity(new Intent(QuizActivity1.this, DifferentiationAndIntegrationActivity.class));
                        break;
                    case R.id.navigation_item_104:
                        startActivity(new Intent(QuizActivity1.this, GreatestCommonDivisorActivity.class));
                        break;
                    case R.id.navigation_item_105:
                        startActivity(new Intent(QuizActivity1.this, LeastCommonMultipleActivity.class));
                        break;
                    case R.id.navigation_item_106:
                        startActivity(new Intent(QuizActivity1.this, LinearSimultaneousEquationsActivity.class));
                        break;
                    case R.id.navigation_item_107:
                        startActivity(new Intent(QuizActivity1.this, MatricesActivity.class));
                        break;
                    case R.id.navigation_item_108:
                        startActivity(new Intent(QuizActivity1.this, ModuloOperationActivity.class));
                        break;
                    case R.id.navigation_item_109:
                        startActivity(new Intent(QuizActivity1.this, OperationsOnComplexNumbersActivity.class));
                        break;
                    case R.id.navigation_item_110:
                        startActivity(new Intent(QuizActivity1.this, PolynomialsActivity.class));
                        break;
                    case R.id.navigation_item_111:
                        startActivity(new Intent(QuizActivity1.this, SeriesActivity.class));
                        break;
                    case R.id.navigation_item_112:
                        startActivity(new Intent(QuizActivity1.this, TrigonometricFunctionsAndIdentitiesActivity.class));
                        break;
                    case R.id.navigation_item_113:
                        startActivity(new Intent(QuizActivity1.this, VectorsActivity.class));
                        break;
                    case R.id.navigation_item_200:
                        startActivity(new Intent(QuizActivity1.this, NumberSystemsActivity.class));
                        break;
                    case R.id.navigation_item_201:
                        startActivity(new Intent(QuizActivity1.this, NumberConversionActivity.class));
                        break;
                    case R.id.navigation_item_202:
                        startActivity(new Intent(QuizActivity1.this, FloatingPointNumberActivity.class));
                        break;
                    case R.id.navigation_item_203:
                        startActivity(new Intent(QuizActivity1.this, NumberRangeActivity.class));
                        break;
                    case R.id.navigation_item_204:
                        startActivity(new Intent(QuizActivity1.this, AssemblerDirectivesActivity.class));
                        break;
                    case R.id.navigation_item_205:
                        startActivity(new Intent(QuizActivity1.this, GettingStartedWithKeiluVisionActivity.class));
                        break;
                    case R.id.navigation_item_206:
                        startActivity(new Intent(QuizActivity1.this, LoadAndStoreInstructionsActivity.class));
                        break;
                    case R.id.navigation_item_207:
                        startActivity(new Intent(QuizActivity1.this, ARMProgrammingMOVInstructionActivity.class));
                        break;
                    case R.id.navigation_item_208:
                        startActivity(new Intent(QuizActivity1.this, ARMProgrammingLDRPseudoInstructionActivity.class));
                        break;
                    case R.id.navigation_item_209:
                        startActivity(new Intent(QuizActivity1.this, ARMProgrammingLoopActivity.class));
                        break;
                    case R.id.navigation_item_210:
                        startActivity(new Intent(QuizActivity1.this, LDMAndSTMInstructionsActivity.class));
                        break;
                    case R.id.navigation_item_211:
                        startActivity(new Intent(QuizActivity1.this, PushAndPopInStackInstructionsActivity.class));
                        break;
                    case R.id.navigation_item_212:
                        startActivity(new Intent(QuizActivity1.this, ARMProgrammingExceptionVectorTableActivity.class));
                        break;
                    case R.id.navigation_item_300:
                        startActivity(new Intent(QuizActivity1.this, BlockDiagramsActivity.class));
                        break;
                    case R.id.navigation_item_301:
                        startActivity(new Intent(QuizActivity1.this, CausalityConditionActivity.class));
                        break;
                    case R.id.navigation_item_302:
                        startActivity(new Intent(QuizActivity1.this, ContinuousTimeFourierSeriesActivity.class));
                        break;
                    case R.id.navigation_item_303:
                        startActivity(new Intent(QuizActivity1.this, ContinuousTimeFourierTransformActivity.class));
                        break;
                    case R.id.navigation_item_304:
                        startActivity(new Intent(QuizActivity1.this, ContinuousTimeFourierTransformPropertiesActivity.class));
                        break;
                    case R.id.navigation_item_305:
                        startActivity(new Intent(QuizActivity1.this, ConvolutionActivity.class));
                        break;
                    case R.id.navigation_item_306:
                        startActivity(new Intent(QuizActivity1.this, DiscreteFourierTransformActivity.class));
                        break;
                    case R.id.navigation_item_307:
                        startActivity(new Intent(QuizActivity1.this, DiscreteTimeFourierSeriesActivity.class));
                        break;
                    case R.id.navigation_item_308:
                        startActivity(new Intent(QuizActivity1.this, DiscreteTimeFourierTransformActivity.class));
                        break;
                    case R.id.navigation_item_309:
                        startActivity(new Intent(QuizActivity1.this, DiscreteTimeFourierTransformPropertiesActivity.class));
                        break;
                    case R.id.navigation_item_310:
                        startActivity(new Intent(QuizActivity1.this, FrequencyResponseActivity.class));
                        break;
                    case R.id.navigation_item_311:
                        startActivity(new Intent(QuizActivity1.this, GibbsPhenomenonActivity.class));
                        break;
                    case R.id.navigation_item_312:
                        startActivity(new Intent(QuizActivity1.this, LaplaceTransformPropertiesActivity.class));
                        break;
                    case R.id.navigation_item_313:
                        startActivity(new Intent(QuizActivity1.this, PartialFractionExpansionActivity.class));
                        break;
                    case R.id.navigation_item_314:
                        startActivity(new Intent(QuizActivity1.this, StabilityConditionActivity.class));
                        break;
                    case R.id.navigation_item_315:
                        startActivity(new Intent(QuizActivity1.this, TransferFunctionActivity.class));
                        break;
                    case R.id.navigation_item_316:
                        startActivity(new Intent(QuizActivity1.this, zTransformActivity.class));
                        break;
                    case R.id.navigation_item_317:
                        startActivity(new Intent(QuizActivity1.this, zTransformPropertiesActivity.class));
                        break;
                }
                return false;
            }
