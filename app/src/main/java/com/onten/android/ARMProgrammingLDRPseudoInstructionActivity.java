...
/**
 * Created by zhenting on 2/11/2015.
 */
public class ARMProgrammingLDRPseudoInstructionActivity extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            // Load a page
            myWebView.loadUrl("http://onteneee.ddns.net/node/48");
